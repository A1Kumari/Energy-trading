                    ...
                    <Row className="align-items-center">
                        <Col md={12} sm={12} lg={6}>
                            <div className="hero-slide-left justify-content-end align-items-center text-center text-lg-start">
                                ...
                                <h1>Better organised healthcare system </h1>
                                <p className="mb-xs-5">Join us to a for encrypted and decentralized prescriptions and appointments. 
                                Our professionals are working so hard to see smile on your face that you deserve! We are dedicated about our duties.</p>
